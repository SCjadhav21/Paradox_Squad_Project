...
//   let responce = await fetch("https://dull-puce-quail-veil.cyclic.app/nda");
...
export async function getServerSideProps(context) {
  ...
  let responce = await fetch(`https://vast-cow-kilt.cyclic.app/nda/${id}`);
  let data = await responce.json();
