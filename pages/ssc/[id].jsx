...
//   let responce = await fetch("https://dull-puce-quail-veil.cyclic.app/ssc");
...
export async function getServerSideProps(context) {
  ...
  let responce = await fetch(`https://vast-cow-kilt.cyclic.app/ssc/${id}`);
  let data = await responce.json();
